...
| **Part 3** | **Thuật toán & Phân tích Độ phức tạp** | • [Bài giảng: Thuật toán là gì? Nhập môn Phân tích Thuật toán](lectures/part-03-thuat-toan-va-do-phuc-tap/introduction-to-algorithm-1-vn.md)<br>• [Bài giảng: Độ phức tạp thuật toán và Ký hiệu tiệm cận](lectures/part-03-thuat-toan-va-do-phuc-tap/complexity-analysis-2-vn.md)<br>• [Bài giảng: Master Theorem, Phương trình truy hồi và Phân tích khấu hao](lectures/part-03-thuat-toan-va-do-phuc-tap/master-theorem-vn.md) | • [Slide: Thuật toán & Mã giả](lectures/part-03-thuat-toan-va-do-phuc-tap/part03-algorithm-pseudocode-en.pdf)<br>• [Slide: Độ phức tạp & Big-O](lectures/part-03-thuat-toan-va-do-phuc-tap/part03-complexity-bigOnotations-en.pdf)<br>• [Slide: Đệ quy & Định lý Master](lectures/part-03-thuat-toan-va-do-phuc-tap/part03-master-theorem-en.pdf) | • [Bài tập: Bài tập Phân tích độ phức tạp (.md)](lectures/part-03-thuat-toan-va-do-phuc-tap/part03-practice-problems-vn.md)<br>• [Bài tập: Practice Exercises (.pdf)](lectures/part-03-thuat-toan-va-do-phuc-tap/part03-pseudocode-basic-counting-en.pdf)<br>• [Bài tập: Assignment 3](lectures/part-03-thuat-toan-va-do-phuc-tap/part03-assignment-en.pdf) | ✅ *Đã sẵn sàng* |
| **Part 4** | **Thuật toán Tìm kiếm & Sắp xếp** | Thuật toán Tìm kiếm tuyến tính/nhị phân, Bubble Sort, Selection Sort, Insertion Sort, Merge Sort, Quick Sort | • [Slide: Thuật toán Sắp xếp (Sorting)](lectures/part-04-tim-kiem-va-sap-xep/part04-sorting-en.pdf) | - | ⏳ *Đang cập nhật* |
